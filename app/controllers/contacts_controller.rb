...
# http_basic_authenticate_with name: "Pedro", password: "123", only: :destroy (CRIPTOGRAFIA PARA APAGAR CONTATOS)
  ...
  def new
    @contact = Contact.new
    @contact.build_address #constroi os atributos do endereço no @contato
  ...
  def update
    respond_to do |format|
      if @contact.update(contact_params)
        format.html { redirect_to @contact, notice: I18n.t('messages.destroyed') }
  ...
  private
    ...
    def contact_params
      ...
      address_attributes: [:streeg, :city, :state], 
